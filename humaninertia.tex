...
configuration of the human for which one desires its inertial properties. This
is done via 21 joint angles between the various segments, all of which are
labeled in Figure \ref{fig:config}. Each segment is labeled with its joint
center as a black dot. The black arrows on each segment indicate its local
coordinate frame, whose origin is always at the joint center of the segment. The green arrows
...
\todo{talk about how many dofs per joint}
