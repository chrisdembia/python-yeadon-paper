...
human aerial movement, particularly somersalts. His first paper
...
compares the trajectory of a double somersalt between a film recording and a
computer simulation using the model developed in the first 3 papers as a way
...
\todo{symmetry of left and right limbs}
